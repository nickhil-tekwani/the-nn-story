...
const CANNED: Array<{ key: string; name: string; description: string; visualization: Visualization; query: AnalyticsQuery }> = [
  ...
  { key: "attendance_by_group", name: "Attendance by group label", description: "Attending groups, attending individuals, and the percentage of all invited groups that accepted for each group label.", visualization: "table", query: { version: 1, dataset: "current_rsvps", measures: ["attending_groups", "attending_individuals", "group_acceptance_rate"], dimensions: ["group_label"], filters: [], sort: [{ field: "group_label", direction: "asc" }], limit: 20, mode: "aggregate" } },
